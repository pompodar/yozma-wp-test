...
!function() {
/*!*****************************************************************!*\
  !*** ../acf-blocks/home-referral-form/assets/scripts/script.js ***!
  \*****************************************************************/
...
jQuery(document).ready(function ($) {
  ...
  selectElements.forEach(function (selectElement) {
    ...
    selectElement.addEventListener('mousedown', function () {
      var click = parseInt(selectElement.getAttribute('data-click'));
  ...
  function toggleArrowRotation(isOpen, selectElement) {
    var arrowIcon = selectElement.closest(
  ...
  var submitButton = $('.referral-form__send-button__inner');
    ...
    if (true) {
      ...
      if ($.inArray(pubcof, autofillPubsCheck) === -1) {
        ...
        grecaptcha.execute('6LfxApIpAAAAAFz-qyorl35V_WZ875Z5Kvae0-QC', {
          ...
          var form = jQuery('#referral__form');
              ...
              if (response !== "Success") {
                ...
                $.ajax({
                  ...
                  success: function (response) {
                    ...
                    var referralForm = $('.referral__form');
...
"use strict";
/*!******************************************************************!*\
  !*** ../acf-blocks/home-referral-form/assets/styles/styles.scss ***!
  \******************************************************************/
...
/******/ })()
;
//# sourceMappingURL=home-referral-form.js.map